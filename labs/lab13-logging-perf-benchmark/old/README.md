...
- Preservation rule: archived files are retained byte-for-byte for traceability.

Do not edit the archived report files. Update only the active report when current guidance changes.
