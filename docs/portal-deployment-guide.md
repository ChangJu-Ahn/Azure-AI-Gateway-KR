...
> **예상 소요 시간:** 60~90분 (APIM Developer 프로비저닝 대기 포함)
...
> ⏱️ Developer 티어는 프로비저닝에 약 30~45분이 소요됩니다.
> AI 전용 정책(`azure-openai-token-limit`, `rate-limit-by-key` 등)을 모두 사용하려면 Developer 이상이 필요합니다.
...
> ℹ️ Developer 티어에서는 왼쪽 메뉴에서 "로거(Loggers)" 메뉴를 포함한 전체 기능을 사용할 수 있습니다.
> Consumption 티어에서는 일부 메뉴가 표시되지 않을 수 있습니다.
